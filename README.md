...
5.	To merge the Klessydra core, and tests:
		...
		a) git clone https://github.com/klessydra/F03x.git
		
		b) cd F03x
		
		c) ./runMErge.sh <pulpino_path>

6.	OPTIONAL: After merging is done, this is how you will be able to test Klessydra-f0-3th.
