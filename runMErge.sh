...
then
	...
	# COPY VHDL FILES
	cp -r $KLESS_PATH/klessydra-f0-3th $PULP_PATH/ips

	# COPY CMAKE/SHELL SCRIPTS
	cp -f $KLESS_PATH/patched_files/f03x_patched_files/cmake_configure.klessydra-f0-3th.gcc.sh $PULP_PATH/sw
	...
	cp $KLESS_PATH/patched_files/f03x_patched_files/vcompile_klessydra-f0-3th.csh $PULP_PATH/vsim/vcompile
	...
	cp $KLESS_PATH/patched_files/common_patched_files/vcompileIPS/vcompile_klessydra-f0-3th.csh $PULP_PATH/vsim/vcompile/ips
